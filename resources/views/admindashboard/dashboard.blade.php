...
@section('content')
    <div class="mx-auto max-w-7xl p-6 max-md:p-4">
        ...
        <div class="mb-8 grid grid-cols-4 gap-6 max-lg:grid-cols-2 max-md:mb-6 max-md:grid-cols-1 max-md:gap-4">

            <div class="rounded-lg bg-white p-6 shadow-md dark:bg-gray-900 max-md:p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 max-md:ml-3">
                        <p class="text-sm font-medium text-gray-600 dark:text-white max-md:text-xs">Total Events</p>
                        <p class="text-2xl font-bold text-gray-900 dark:text-white max-md:text-xl">{{ $summaryStats['total_events'] ?? 0 }}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="rounded-lg bg-white p-6 shadow-md dark:bg-gray-900 max-md:p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 max-md:ml-3">
                        <p class="text-sm font-medium text-gray-600 dark:text-white max-md:text-xs">Total Bookings</p>
                        <p class="text-2xl font-bold text-gray-900 dark:text-white max-md:text-xl">
            ...
            <div class="rounded-lg bg-white p-6 shadow-md dark:bg-gray-900 max-md:p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 max-md:ml-3">
                        <p class="text-sm font-medium text-gray-600 dark:text-white max-md:text-xs">Upcoming Events</p>
                        <p class="text-2xl font-bold text-gray-900 dark:text-white max-md:text-xl">
            ...
            <div class="rounded-lg bg-white p-6 shadow-md dark:bg-gray-900 max-md:p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 max-md:ml-3">
                        <p class="text-sm font-medium text-gray-600 dark:text-white max-md:text-xs">Total Capacity</p>
                        <p class="text-2xl font-bold text-gray-900 dark:text-white max-md:text-xl">
        ...
        <div class="rounded-lg bg-white p-6 shadow-md dark:bg-gray-900 max-md:p-4">
            ...
            <div class="mb-6 flex items-center justify-between max-md:mb-4">
                <h2 class="text-xl font-bold text-gray-900 dark:text-white max-md:text-lg">Events Report</h2>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full table-auto dark:bg-gray-800">
                    <thead class="bg-gray-50 dark:bg-gray-700">
                        <tr>
                            <th
                                class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500 dark:text-white max-md:px-3 max-md:py-2">
                                Event Title
                            </th>
                            <th
                                class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500 dark:text-white max-md:px-3 max-md:py-2">
                            ...
                            <tr class="hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700">
                                <td class="whitespace-nowrap px-6 py-4 max-md:px-3 max-md:py-3">
                                    <a href="/events/{{ $event->uuid }}" class="cursor-pointer no-underline">
                                        <div class="text-sm font-medium text-gray-900 dark:text-white max-md:text-xs">
                                            {{ $event->title }}
                                        </div>
                                    </a>

                                    <div class="text-sm text-gray-500 dark:text-white max-md:text-xs">
                                        {{ Str::limit($event->description ?? 'No description', 50) }}
                                    </div>
                                </td>
                                <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-900 dark:text-white max-md:px-3 max-md:py-3 max-md:text-xs">
                                ...
                                <td class="whitespace-nowrap px-6 py-4 max-md:px-3 max-md:py-3">
                                    <span class="text-sm font-medium text-gray-900 dark:text-white max-md:text-xs">
                                ...
                                <td class="whitespace-nowrap px-6 py-4 max-md:px-3 max-md:py-3">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <span
                                            class="text-sm font-medium text-gray-900 dark:text-white max-md:text-xs">{{ $occupancyRate }}%</span>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
            ...
            <div class="mt-6 border-t border-gray-200 pt-6 max-md:mt-4 max-md:pt-4">
                <div class="grid grid-cols-3 gap-4 text-sm max-md:grid-cols-1 max-md:gap-3 max-md:text-xs">
                    <div class="rounded-lg bg-gray-50 p-4 text-center dark:bg-gray-800 max-md:p-3">
                    ...
                    <div class="rounded-lg bg-gray-50 p-4 text-center dark:bg-gray-800 max-md:p-3">
                        ...
                        <p class="text-2xl font-bold text-green-600 max-md:text-xl">{{ collect($eventsDetails)->sum('capacity') }}
                        </p>
                    </div>
                    <div class="rounded-lg bg-gray-50 p-4 text-center dark:bg-gray-800 max-md:p-3">
